...
obj
	Blank_Slot
		...
		Slot5
			...
			ind=list("Akimichi",null,null,null,null,null)
		Slot6
			pixel_x=-16
			im=list(null,null,null,'CreationScreen/traits/trait-genius.png','CreationScreen/traits/trait-genius.png','CreationScreen/traits/trait-genius.png')
			aim=list(null,null,null,'CreationScreen/traits/trait-geniusS.png','CreationScreen/traits/trait-geniusS.png','CreationScreen/traits/trait-geniusS.png')
			ind=list(null,null,null,"Genius","Genius","Genius")
		New()
			..()
